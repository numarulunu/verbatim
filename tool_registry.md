...
| 2026-04-23 | v1.0 | Verbatim Updater Sanitization + Public Feed | Electron desktop app | Stopped raw updater transport errors from rendering in the header, hid non-actionable update banners, aligned shell surfaces closer to the Minifier reference, and switched the GitHub release feed to a public repo so installed builds can auto-update. |
